...
const CaptainHome = () => {
            ...
            if (navigator.geolocation) {
                navigator.geolocation.getCurrentPosition(position => {
                    socket.emit('update-location-captain', {
                        userId: captain._id,
                        location: {
                            lat: position.coords.latitude, // ✅ fixed typo from "ltd"
    ...
    useEffect(() => {
        ...
        return () => socket.off('new-ride') // ✅ cleanup listener
    }, [socket])
    ...
    return (
        <div className='h-screen'>
            ...
            <div className='h-3/5'>
                <img className='h-full w-full object-cover' src="https://miro.medium.com/v2/resize:fit:1400/0*gwMx05pqII5hbfmX.gif" alt="Map Animation" />
            </div>
